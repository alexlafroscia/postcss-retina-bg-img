...
const { distributeQueryAcrossQuery, queryCoversRange, nodeIsMediaQuery } = require('./utils/media-query');
...
function retinaBackgroundImage(options) {
  return function(root, result) {
    ...
    if (!Array.isArray(includeFileExt)) {
      throw new Error('Option `includeFileExtensions` must be an array. You passed: ' + includeFileExt);
    }
